...
func (sdc *SDC) ConvertToHeader() *requests.SAPSalesOrderHeader {
	data := sdc.SAPSalesOrderHeader
	return &requests.SAPSalesOrderHeader{
...
func (sdc *SDC) ConvertToHeaderPartner(num int) *requests.SAPSalesOrderHeaderPartner {
	data := sdc.SAPSalesOrderHeader.SAPSalesOrderHeaderPartner[num]
	return &requests.SAPSalesOrderHeaderPartner{
		SalesOrder:      data.SalesOrder,
...
func (sdc *SDC) ConvertToItem(num int) *requests.SAPSalesOrderItem {
	dataSalesOrder := sdc.SAPSalesOrderHeader
	data := sdc.SAPSalesOrderHeader.SAPSalesOrderItem[num]

	return &requests.SAPSalesOrderItem{
...
func (sdc *SDC) ConvertToItemPricingElement(num int) *requests.SAPSalesOrderItemPricingElement {
	dataSalesOrder := sdc.SAPSalesOrderHeader
	dataItem := dataSalesOrder.SAPSalesOrderItem[num]
	data := dataItem.SAPSalesOrderItemPricingElement[num]
	return &requests.SAPSalesOrderItemPricingElement{
		SalesOrder:                     dataSalesOrder.SalesOrder,
...
func (sdc *SDC) ConvertToItemScheduleLine(num int) *requests.SAPSalesOrderItemScheduleLine {
	dataSalesOrder := sdc.SAPSalesOrderHeader
	dataItem := dataSalesOrder.SAPSalesOrderItem[num]
	data := dataItem.SAPSalesOrderItemScheduleLine[num]
	return &requests.SAPSalesOrderItemScheduleLine{
		SalesOrder:                    dataSalesOrder.SalesOrder,
		SalesOrderItem:                dataItem.SalesOrderItem,
